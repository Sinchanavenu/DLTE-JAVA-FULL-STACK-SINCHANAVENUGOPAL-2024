...
//    //here testing the endpoints using http request and response.
//
//    @MockBean
...
//    //MockMvc is used to simulate HTTP requests and verify the responses from the controllers.
//
...
//                "    }";
//
//        Transaction transaction=new Transaction(1272345L,new Date("10/20/2024"),"Venki","Manoj",50000.0,"Friend");
...
//        Transaction transaction1=new Transaction(12323456L,new Date("10/20/2024"),"Ramesh","Suresh",11000.0,"Friend");
//        Transaction transaction2=new Transaction(765423436L,new Date("11/8/2024"),"Venkatesh","Prajwal",32000.0,"Health");
//        Transaction transaction3=new Transaction(176543343L,new Date("24/9/2024"),"Razi","Darshan",25000.0,"Education");
//
