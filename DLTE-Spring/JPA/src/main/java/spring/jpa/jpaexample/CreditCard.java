...
public class CreditCard implements Serializable {
    @Id @GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "sinchana")
    @SequenceGenerator(name = "sinchana",sequenceName = "zoya",initialValue = 100,allocationSize = 1)
