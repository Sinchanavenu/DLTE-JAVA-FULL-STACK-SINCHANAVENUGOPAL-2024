...
public class EmployeeDetails {
    ...
    public EmployeeDetails(String name, String id, String email, String house, String permanentHouseNumber, String permanentCity, String permanentState, int permanentPinCode, String houseName, String temporaryHouseNumber, String temporaryCity, String temporaryState, int temporaryPinCode) {
    }
