...
import employee.pojo.EmployeeAddressConsole;
import employee.pojo.EmployeeConsole;
import employee.pojo.EmployeeDetailsConsole;
import org.example.Entity.Employee;
import org.example.Entity.EmployeeAddress;
import org.example.Entity.EmployeebasicDetails;
import org.example.Entity.InputEmployeeDetails;
...
// Close connections
    ...
    private static EmployeeConsole translateBack(Employee employee) {
        EmployeeDetailsConsole employeeBasicDetailsConsole=new EmployeeDetailsConsole();
    ...
    private static Employee translateEmployee(EmployeeConsole employeeConsole) {
        ...
        employeebasicDetails.setEmployeeName(employeeConsole.getEmployeeDetailsConsole().getEmployeeName());
        employeebasicDetails.setEmployeeId(employeeConsole.getEmployeeDetailsConsole().getEmployeeId());
        employeebasicDetails.setEmailId(employeeConsole.getEmployeeDetailsConsole().getEmailId());
        employeebasicDetails.setPhoneNumber(employeeConsole.getEmployeeDetailsConsole().getPhoneNumber());
