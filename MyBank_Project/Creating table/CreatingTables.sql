...
KYC_AADHAR VARCHAR2(12)UNIQUE NOT NULL,
...
create sequence TRANSACTIONID_SEQ2 start with 1000 increment by 1;
 
create table MYBANK_APP_TRANSACTION(
TRANSACTION_ID NUMBER(20),
TRANSACTION_TYPE VARCHAR2(255) NOT NULL,
TRANSACTION_FROM NUMBER(10),
TRANSACTION_TO NUMBER(10),
...
alter table MYBANK_APP_TRANSACTION add constraint TRANSACTIONID_SEQ2 primary key(TRANSACTION_ID);
---------------------
...
DEBITCARD_PIN NUMBER(5) NOT NULL,
